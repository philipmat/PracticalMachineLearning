...
df.cm <- data.frame(cm.all$overall, cm.angles$overall, cm.raw$overall)
kable(df.cm, col.names = c('All Predictors (52)', 'Angle Predictors (12)', 'Raw Sensors (40)'), caption = 'Comparison of accuracy for various predictors')
```
